...
"""[Your brilliant code here]"""
userName = input("Welcome to the Magic 8 Ball.  Type your name and press enter:")
...
while playAgain == "y":
    ...
    input("Ask me a question out loud and press return")
    ...
    print(answers[random.randint(0,19)], userName)
    ...
    playAgain = input("press [y] for yes or any other key for no. Then press [return]:")
